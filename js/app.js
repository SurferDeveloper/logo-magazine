...
if (document.querySelector('.brands-slider')) {
	let brandssSlider = new Swiper('.brands-slider__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 5,
		spaceBetween: 0,
...
if (document.querySelector('.images-product')) {
	...
	let imagesMainsSlider = new Swiper('.images-product__mainslider', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
//Опять не работает _slideToggle
...
// 		//_slideToggle(filterTitle.nextElementSibling);не работает! Далее свой вариант
